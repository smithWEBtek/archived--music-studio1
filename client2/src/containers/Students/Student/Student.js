...
const Student = (props) => {
  ...
  if (student) {
    studentHeader = (
      <div>
        <hr />
        <h1 className={appstyles.StudentHeaderBackground}>{student.firstname} {student.lastname}</h1>
  ...
  if (student && student.lessons) {
    studentLessons = (
      <div>
        <hr />
        <h5 className={appstyles.LessonHeaderBackground}>LESSONS recorded for <strong>{student.firstname}</strong></h5>
  ...
  if (student && student.resources) {
    studentResources = (
      <div>
        <hr />
        <h5 className={appstyles.ResourceHeaderBackground}>RESOURCES assigned to <strong>{student.firstname}</strong></h5>
