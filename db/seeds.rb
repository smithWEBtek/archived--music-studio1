...
DATA_resources = {
  ...
  :resources => [
    ["El_Manisero", "Salsa", "salsa chart", "pdf", "https://res.cloudinary.com/smithwebtek/image/upload/v1509296858/charts/El_Manisero.pdf"],
    ["Frenesi", "Salsa", "salsa chart", "pdf", "https://res.cloudinary.com/smithwebtek/image/upload/v1509296858/charts/Frenesi.pdf"],
    ["El_Cuarto_de_Tula", "Salsa", "salsa chart", "pdf", "https://res.cloudinary.com/smithwebtek/image/upload/v1509296858/charts/El_Cuarto_de_Tula.pdf"],
    ["Capullito_De_Aleli", "Salsa", "salsa chart", "pdf", "https://res.cloudinary.com/smithwebtek/image/upload/v1509296858/charts/Capullito_De_Aleli.pdf"],
    ["El_Cantante-leadSheet", "Salsa", "salsa chart", "pdf", "https://res.cloudinary.com/smithwebtek/image/upload/v1509296858/charts/El_Cantante-leadSheet.pdf"],
    ["Guantanamera", "Salsa", "salsa chart", "pdf", "https://res.cloudinary.com/smithwebtek/image/upload/v1509296858/charts/Guantanamera.pdf"],
    ["Chan_Chan_-_lead_sheet", "Salsa", "salsa chart", "pdf", "https://res.cloudinary.com/smithwebtek/image/upload/v1509296857/charts/Chan_Chan_-_lead_sheet.pdf"],
    ["Chucho", "Salsa", "salsa chart", "pdf", "https://res.cloudinary.com/smithwebtek/image/upload/v1509296857/charts/Chucho.pdf"],
    ["Castellano_Que_Bueno_Baila_Usted", "Salsa", "salsa chart", "pdf", "https://res.cloudinary.com/smithwebtek/image/upload/v1509296857/charts/Castellano_Que_Bueno_Baila_Usted.pdf"],
    ["A_Night_In_Tunisia", "Salsa", "salsa chart", "pdf",
    ...
    ['blues in F', 'blues', '12 bar blues', 'doc', 'cloud'],
    ['II-V-I 4bar', 'improv', '4 bar phrases', 'aud', 'cloud'],
    ['maj triad', 'chords', 'major triad inversions', 'doc', 'cloud'],
    ['min triad', 'chords', 'minor triad inversions', 'vid', 'cloud'],
    ['dom7', 'chords', 'dom7 inversions', 'doc', 'cloud'],
    ['min7', 'chords', 'min7 inversions', 'doc', 'cloud'],
    ['min7b5', 'chords', 'min7b5 inversions', 'doc', 'cloud'],
    ['maj7', 'chords', 'maj7 inversions', 'doc', 'cloud'],
    ['major scales', 'scales', 'major scales', 'aud', 'cloud'],
    ['minor scales', 'scales', 'minor scales', 'doc', 'cloud'],
    ['modal scales', 'scales', 'modal scales', 'vid', 'cloud'],
    ['alt scales', 'scales', 'alt scales', 'doc', 'cloud'],
    ['chord tones', 'improv', 'chord tones', 'vid', 'cloud'],
    ['approach notes', 'improv', 'approach notes', 'doc', 'cloud'],
    ['bi chords', 'improv', 'bi chords', 'doc', 'cloud'],
    ['Autumn Leaves', 'tune', 'standard', 'doc', 'cloud'],
    ['Blue Bossa', 'tune', 'standard', 'vid', 'cloud'],
    ['All The Things', 'tune', 'standard', 'doc', 'cloud'],
